...
נכון לסריקה האחרונה, `npm run test:run` עובר עם 139 בדיקות.
...
- מודולים לווסתות מתקדמים עם בדיקות ייעודיות.
...
- לחבר באופן מלא את כל מודולי הווסתות המתקדמים אל `calculator.ts`, כדי שהאורקסטרטור הראשי יחזיר גם אותם בתוצאות החודשיות.
- לחבר יצירה ועדכון של `VesetRecord` כאשר מזוהה וסת קבוע חדש.
